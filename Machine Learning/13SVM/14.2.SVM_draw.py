...
if __name__ == "__main__":
    ...
    for i, clf in enumerate(clfs):
        ...
        #print(grid_hat) 500行*500
        plt.pcolormesh(x1, x2, grid_hat, cmap=cm_light, alpha=0.8)#alpha调节透明度
        ...
        z = clf.decision_function(grid_test)#预测的可能性数值
        #print(z)
        ...
        plt.title(titles[i])
        plt.grid()
    plt.suptitle('SVM不同参数的分类', fontsize=18)
    plt.tight_layout(2)
