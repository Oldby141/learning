...
if __name__ == "__main__":
    ...
    feature_names = np.asarray(vectorizer.get_feature_names())#主要区别在于 np.array （默认情况下）将会copy该对象，而 np.asarray 除非必要，否则不会copy该对象。
    ...
    plt.xticks(x+0.25, names, fontsize=10)
